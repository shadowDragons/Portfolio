    ...
    <html lang={locale}>
      <body className={`${poppins.variable} ${rubik.variable}`}>
        <NextIntlClientProvider messages={messages}>
          ...
          <main
            className={cn(
              'flex flex-col relative break-words min-h-screen pt-14 pb-4 px-40 max-md:p-4 bg-transparent max-sm:pt-20',
              'bg-[linear-gradient(to_right,#e5e7eb_1px,transparent_1px),linear-gradient(to_bottom,#e5e7eb_1px,transparent_1px)] bg-[size:24px_24px]'
            )}
          >
            {children}
          </main>
